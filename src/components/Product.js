  ...
  return (
    <div>
      <div className='border h-[300px] mb-4 relative overflow-hidden group transition'>
        ...
        <div className='absolute top-1 -right-11 group-hover:right-1 p-2 opacity-0 group-hover:opacity-100 transition-all duration-300'>
          <button onClick={()=>addToCart(product,id)}><div className='flex bg-red-500 justify-center items-center text-white w-10 h-10'><BsPlus className='text-3xl'/></div></button>
