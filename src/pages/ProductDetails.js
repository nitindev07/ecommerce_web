...
const ProductDetails = () => {
  ...
  const { image, title, price, description } = pro;
        ...
        <div className="flex items-center lg:flex-row flex-col">
          ...
          <div className="flex-1">
            <div className="flex flex-col gap-y-5">
              ...
              <button className="bg-primary mx-auto lg:mx-0 text-white w-[150px] py-3 px-3" onClick={()=>addToCart(pro ,id)} >Add To Cart</button>
            </div>
          </div>
        </div>
      </div>
